...
const InvitePage = () => {
    ...
    // }, []);
     ...
     return (
        <>
        <a href='/' className='letterheader'><img className='headerlogo' src='/pazamafont.png' alt='logo' width='120px' height='60px'></img></a>
        ...
        {token !== "undefined" && token ? (
          <>
            <a href='/room/' className='clicklink'>JOIN PARTY</a>
          </>
        ) : (
          <>
            <a href='/login' className='clicklink'>로그인이 필요합니다!</a>
          </>
        )}
        </>
     );
